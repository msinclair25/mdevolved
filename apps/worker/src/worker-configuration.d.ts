/* eslint-disable */
// Generated by Wrangler by running `wrangler types apps/worker/src/worker-configuration.d.ts` (hash: 35273d8bc595d418ff305ad85d7f3a84)
// Runtime types generated with workerd@1.20260721.1 2026-07-26 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	OAUTH_KV: KVNamespace;
	VAULT_STORAGE: R2Bucket;
	DB: D1Database;
	OAUTH_REGISTRATION_ROUTE_LIMITER: RateLimit;
	OAUTH_REGISTRATION_CLIENT_LIMITER: RateLimit;
	OAUTH_TOKEN_CLIENT_LIMITER: RateLimit;
	SOCKET_TICKET_IP_LIMITER: RateLimit;
	SOCKET_TICKET_VAULT_LIMITER: RateLimit;
	WORKER_VERSION: WorkerVersionMetadata;
	ASSETS: Fetcher;
	APP_DEPLOYMENT_MODE: "community";
	APP_ENVIRONMENT: "production";
	APP_VERSION: "1.0.0-alpha.7";
	EXPECTED_HOSTNAME: "";
	VAULTS: DurableObjectNamespace<import("./index").VaultCoordinator>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_DEPLOYMENT_MODE" | "APP_ENVIRONMENT" | "APP_VERSION" | "EXPECTED_HOSTNAME">> {}
}

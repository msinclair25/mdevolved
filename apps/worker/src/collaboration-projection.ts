...
function renderDecision(
  ...
  return [
    ...
    "",
    "> [!info] Derived OWD projection",
    `> This immutable note is a human-readable view of Decision \`${decision.decisionId}\`. The structured OWD ledger remains authoritative.`,
    "",
    "## Project",
    "",
    project.label,
    ...
    "## Provenance",
    "",
    `- OWD Project: \`${decision.projectId}\``,
    `- OWD Work Item: \`${decision.workItemId}\``,
    `- OWD Decision: \`${decision.decisionId}\``,

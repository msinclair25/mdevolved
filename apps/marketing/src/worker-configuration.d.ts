/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc src/worker-configuration.d.ts` (hash: 2d89280138690a6d31a552b01b30cfc2)
// Runtime types generated with workerd@1.20260721.1 2026-07-28 
interface __BaseEnv_Env {
	ALPHA_ACCESS_EMAIL: SendEmail;
	ALPHA_ACCESS_RATE_LIMIT: RateLimit;
	ASSETS: Fetcher;
}

...
export const ALBATROSS_MCP_REMOTE_VERSION = "0.14.3";
...
/**
 * Albatross 2.5.0 is a stdio-only MCP client. This profile keeps MDevolved's
...
- Albatross 2.5.0 reads MCP text content but ignores server initialize instructions, Resources, Prompts, and \`structuredContent\`. Treat the JSON text returned by MDevolved as authoritative and keep this managed prompt block installed. Its Agent Skills support may load this inert pack, but a skill never grants MDevolved authority.

...
export const OBSIDIAN_MIND_COMPATIBILITY_PROFILE = {
  ...
  identity: {
    ...
    rule: "Use .om-project only for Obsidian Mind memory routing. Use the UUID in .owdignore for OWD authorization, resume, and Project identity.",
...
3. Read AGENTS.md and CLAUDE.md. Read .owdignore when present, then call resume_project with its exact Project UUID and context policy. If no receipt exists, call open_project with the user's visible Project name.
